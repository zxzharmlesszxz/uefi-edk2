  ...
  )
{
  ...
  OutputBuffer = (VOID*) ((UINT8*)(UINTN) PcdGet32 (PcdBhyveMemFvBase) + SIZE_1MB);
  ...
  NewFv = (EFI_FIRMWARE_VOLUME_HEADER*)(UINTN) PcdGet32 (PcdBhyveMemFvBase);
  CopyMem (NewFv, (VOID*) (NewFvSection + 1), PcdGet32 (PcdBhyveMemFvSize));
